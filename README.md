...
* Unique feature: pressing `ctrl-b` three times opens a portal. `ctrl-v` in another file will then pop lines from the portal. This modifies both files! `esc` closes the portal.
