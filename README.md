...
Alternatively, download and install a [release version](https://github.com/xyproto/o/releases). For example, for Raspberry Pi 2, 3 or 4 running Linux:
    ...
    curl -sL 'https://github.com/xyproto/o/releases/download/2.49.1/o-2.49.1-linux_rpi234.tar.xz' | tar JxC /tmp && sudo install -Dm755 /tmp/o-2.49.1-linux_rpi234/o /usr/bin/o && sudo install -Dm644 /tmp/o-2.49.1-linux_rpi234/o.1.gz /usr/share/man/man1/o.1.gz
