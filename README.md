...
* Press `right, down, left` or `left, down, right` in a rapid succession followed by `down` to save and quit or type in a command. This shortcut is handy to avoid [the emacs pinky](http://xahlee.info/emacs/emacs/emacs_pinky.html).
