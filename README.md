...
* Being on a live image for a Linux distro or BSD, since it supports VT100, is small and self-contained, has a built-in man page viewer, can be used for editing `/etc/fstab` and viewing logs.
...
Alternatively, download and install a [release version](https://github.com/xyproto/o/releases). For example, for Raspberry Pi 2, 3 or 4 running Linux:
    ...
    curl -sL 'https://github.com/xyproto/o/releases/download/2.55.0/o-2.55.0-linux_armv7_static.tar.xz' | tar JxC /tmp && sudo install -Dm755 /tmp/o-2.55.0-linux_armv7_static/o /usr/bin/o && sudo install -Dm644 /tmp/o-2.55.0-linux_armv7_static/o.1.gz /usr/share/man/man1/o.1.gz
