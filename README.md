...
* Being included on live ISO images for Linux distros, since it is self-contained, supports VT100, has a built-in man page viewer and can be used together with [`fstabfmt`](https://github.com/xyproto/fstabfmt).
