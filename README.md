...
Alternatively, download and install a [release version](https://github.com/xyproto/orbiton/releases). For example, for Raspberry Pi 2, 3 or 4 running Linux:
    ...
    curl -sL 'https://github.com/xyproto/orbiton/releases/download/2.62.5/orbiton-2.62.5-linux_armv7_static.tar.xz' | tar axC /tmp && sudo install -Dm755 /tmp/orbiton-2.62.5-linux_armv7_static/o /usr/bin/o && sudo install -Dm644 /tmp/orbiton-2.62.5-linux_armv7_static/o.1.gz /usr/share/man/man1/o.1.gz
