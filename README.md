...
Alternatively, download and install a [release version](https://github.com/xyproto/o/releases). For example, for Raspberry Pi 2, 3 or 4 running Linux:
    ...
    curl -sL 'https://github.com/xyproto/o/releases/download/2.40.0/o-2.40.0-rpi.tar.xz' | tar JxC /tmp && sudo install -Dm755 /tmp/o-2.40.0-rpi/o /usr/bin/o && sudo install -Dm644 /tmp/o-2.39.2-rpi/o.1.gz /usr/share/man/man1/o.1.gz
