...
var languageIndentation = map[TabsSpaces][]Mode{
	...
	{4, false}: {C, Go, GoAssembly, HIDL, Lisp, M4, Makefile, ManPage, Nroff, OCaml, Odin, Rust, StandardML}, // Tabs
	// Languages that use spaces (from the opinionated point of view of this package)
	{2, true}: {Amber, Assembly, Clojure, Config, HTML, Haskell, JSON, Lua, ObjectPascal, Perl, PolicyLanguage, Shell, Vim, Vim, XML},
