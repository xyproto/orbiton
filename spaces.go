...
var languageIndentation = map[TabsSpaces][]Mode{
	...
	{2, true}:  {modeAssembly, modeClojure, modeConfig, modeHTML, modeHaskell, modeJSON, modeLua, modeObjectPascal, modePolicyLanguage, modeShell, modeVim, modeVim, modeXML},
