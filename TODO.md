...
- [ ] Instead of sleeping in a goroutine before clearing the highlighted line, do a check for how much time has elapsed when redrawing at the end of the loop.
