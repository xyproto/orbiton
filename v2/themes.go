...
func NewOrbTheme() Theme {
	return Theme{
		...
		SearchHighlight:             vt100.LightCyan,
		MultiLineComment:            vt100.Gray,
		MultiLineString:             vt100.LightGreen,
		...
		HTMLColor:                   vt100.Gray,
		CommentColor:                vt100.Gray,
		BoldColor:                   vt100.LightGreen,
		ItalicsColor:                vt100.LightGray,
		StrikeColor:                 vt100.Gray,
		TableColor:                  vt100.Gray,
		CheckboxColor:               vt100.Gray,
...
func NewRedBlackTheme() Theme {
	...
	return Theme{
		...
		HighlightBackground:         vt100.BackgroundRed,
		Git:                         vt100.LightGreen,
		String:                      "white",
		Keyword:                     "darkred",
		Comment:                     "darkgray",
...
func NewDarkBlueEditTheme() Theme {
	return Theme{
		...
		HighlightForeground:         vt100.LightYellow,
		HighlightBackground:         vt100.BackgroundCyan,
		Git:                         vt100.White,
		String:                      "lightyellow",
		Keyword:                     "lightyellow",
		Comment:                     "lightgray",
...
func NewDarkVSTheme() Theme {
	return Theme{
		...
		MultiLineComment:            vt100.Gray,
		MultiLineString:             vt100.Red,
		HighlightForeground:         vt100.Blue,
