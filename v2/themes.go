...
func NewOrbTheme() Theme {
	return Theme{
		...
		DebugStoppedBackground:      vt.LightRed,
...
func NewTealTheme() Theme {
	return Theme{
		...
		StatusBackground:            vt.BackgroundBlack,
		StatusErrorForeground:       vt.LightRed,
		StatusErrorBackground:       vt.BackgroundGray,
		SearchHighlight:             vt.Red,
		MultiLineComment:            vt.Gray,
		MultiLineString:             vt.Blue,
		HighlightForeground:         vt.White,
		HighlightBackground:         vt.BackgroundDefault,
		Git:                         vt.Blue,
		String:                      "lightcyan",
		...
		Mut:                         "blue",
		RainbowParenColors:          []vt.AttributeColor{vt.LightRed, vt.LightGray, vt.LightBlue, vt.Blue},
		MarkdownTextColor:           vt.Cyan,
		HeaderBulletColor:           vt.LightGray,
		HeaderTextColor:             vt.LightGray,
		ListBulletColor:             vt.LightGray,
		ListTextColor:               vt.Cyan,
		ListCodeColor:               vt.Cyan,
		CodeColor:                   vt.LightGray,
		CodeBlockColor:              vt.LightGray,
		ImageColor:                  vt.LightGray,
		LinkColor:                   vt.LightGray,
		...
		ItalicsColor:                vt.LightGray,
		StrikeColor:                 vt.DarkGray,
		TableColor:                  vt.LightGray,
		CheckboxColor:               vt.Cyan,
		XColor:                      vt.LightGray,
		TableBackground:             vt.BackgroundDefault,
		UnmatchedParenColor:         vt.LightGray,
		MenuTitleColor:              vt.LightBlue,
		MenuArrowColor:              vt.LightCyan,
		MenuTextColor:               vt.Gray,
		MenuHighlightColor:          vt.Cyan,
		MenuSelectedColor:           vt.White,
		ManSectionColor:             vt.LightGray,
		ManSynopsisColor:            vt.LightGray,
		BoxTextColor:                vt.Black,
		BoxBackground:               vt.BackgroundBlue,
		BoxHighlight:                vt.LightGray,
		...
		DebugRegistersBackground:    vt.BackgroundGreen,
		DebugOutputBackground:       vt.BackgroundCyan,
		DebugInstructionsForeground: vt.LightCyan,
		DebugInstructionsBackground: vt.BackgroundBlue,
		BoxUpperEdge:                vt.LightGray,
		JumpToLetterColor:           vt.LightGreen,
		NanoHelpForeground:          vt.Black,
		NanoHelpBackground:          vt.BackgroundGray,
	}
}
...
func NewLightVSTheme() Theme {
	return Theme{
		...
		BoxHighlight:                vt.Red,
		DebugRunningBackground:      vt.BackgroundCyan,
		DebugStoppedBackground:      vt.BackgroundDefault,
		DebugRegistersBackground:    vt.BackgroundGray,
		DebugOutputBackground:       vt.BackgroundGray,
...
func NewDarkVSTheme() Theme {
	return Theme{
		...
		BoxHighlight:                vt.Red,
		DebugRunningBackground:      vt.BackgroundCyan,
		DebugStoppedBackground:      vt.Gray,
		DebugRegistersBackground:    vt.BackgroundGray,
		DebugOutputBackground:       vt.BackgroundGray,
		DebugInstructionsForeground: vt.Black,
		DebugInstructionsBackground: vt.BackgroundGray,
