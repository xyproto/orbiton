...
func NewPinetreeTheme() Theme {
	return Theme{
		...
		MultiLineString:             Magenta,
		HighlightForeground:         LightGreen,
		HighlightBackground:         BackgroundBlack,
		Git:                         LightGreen,
		String:                      "lightgreen",
		Keyword:                     "lightred",
...
func NewSynthwaveTheme() Theme {
	return Theme{
		...
		MultiLineComment:            Gray,
		MultiLineString:             Magenta,
		HighlightForeground:         LightMagenta,
		HighlightBackground:         BackgroundDefault,
		Git:                         Cyan,
		String:                      "lightgray",
		Keyword:                     "magenta",
...
func NewRedBlackTheme() Theme {
	...
	return Theme{
		...
		Light:                       false,
		Foreground:                  LightGray,
		Background:                  BackgroundBlack, // Dark gray background, as opposed to BackgroundDefault
		StatusForeground:            White,
		StatusBackground:            BackgroundBlack,
		StatusErrorForeground:       LightRed,
		StatusErrorBackground:       BackgroundDefault,
		...
		CheckboxColor:               Default,
		XColor:                      Red,
		TableBackground:             BackgroundBlack, // Dark gray background, as opposed to BackgroundDefault
