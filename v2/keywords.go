...
var (
	...
	// Flap
	flapWords = []string{"&b", "<<<b", "<<b", "<b", ">>>b", ">>b", ">b", "^b", "and", "as", "cstr", "defer", "eprint", "eprintf", "eprintln", "exit", "exitf", "exitln", "f32", "f64", "i16", "i32", "i64", "i8", "in", "list", "me", "not", "number", "or", "or!", "or!", "print", "printf", "printf", "println", "println", "ptr", "ret", "string", "u16", "u32", "u64", "u8", "xor", "|b", "~b"}
