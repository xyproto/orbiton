...
var (
	...
	// POV-Ray
	povrayWords = []string{
		"sphere", "box", "cylinder", "cone", "torus", "plane", "triangle", "smooth_triangle", "polygon", "height_field", "text", "blob", "lathe", "sor", "prism", "superellipsoid", "quartic", "cubic", "poly", "quadric", "disc", "bicubic_patch", "triangle_fan", "mesh", "mesh2", "isosurface", "parametric",
		"union", "intersection", "difference", "merge",
		"translate", "rotate", "scale", "matrix", "transform", "inverse_transform",
		"light_source", "area_light", "spotlight", "cylindrical", "parallel", "fade_distance", "fade_power", "looks_like", "point_at", "tightness", "radius", "falloff", "jitter", "adaptive", "circular", "orient",
		"camera", "perspective", "orthographic", "fisheye", "ultra_wide_angle", "omnimax", "panoramic", "spherical", "cylinder", "location", "look_at", "direction", "right", "up", "sky", "angle", "confidence", "variance",
		"pigment", "normal", "finish", "texture", "material", "interior", "media", "photons", "color", "colour", "rgb", "rgbf", "rgbt", "rgbft", "red", "green", "blue", "filter", "transmit", "ambient", "diffuse", "brilliance", "phong", "phong_size", "specular", "roughness", "metallic", "reflection", "refraction", "ior", "caustics", "dispersion", "dispersion_samples",
		"agate", "bozo", "brick", "bumps", "cells", "checker", "crackle", "cylindrical", "dents", "facets", "granite", "leopard", "marble", "onion", "planar", "quilted", "radial", "ripples", "spherical", "spiral1", "spiral2", "spotted", "waves", "wood", "wrinkles",
		"turbulence", "octaves", "omega", "lambda", "frequency", "phase", "warp", "black_hole", "repeat", "offset", "slope_map", "color_map", "pigment_map", "normal_map", "texture_map", "image_map", "bump_map",
		"jpeg", "tiff", "png", "gif", "tga", "iff", "ppm", "pgm", "pbm", "sys", "once", "map_type", "interpolate", "use_color", "use_index", "alpha",
		"fog", "rainbow", "skysphere", "background", "global_settings", "radiosity", "photons", "assumed_gamma", "hf_gray_16", "charset", "irid", "irid_wavelength", "irid_thickness", "conserve_energy",
		"scattering", "absorption", "emission", "density", "samples", "intervals", "ratio", "confidence", "variance", "count", "error_bound", "minimum_reuse", "maximum_reuse", "nearest_count", "recursion_limit",
		"adc_bailout", "max_trace_level", "number_of_waves", "noise_generator", "subsurface", "radiosity", "brightness", "gather", "media", "method", "density_file", "df3",
		"declare", "local", "undef", "version", "include", "fopen", "fclose", "read", "write", "append", "concat", "chr", "asc", "str", "substr", "strlen", "strlwr", "strupr", "datetime", "seed", "rand", "min", "max", "mod", "abs", "sign", "sqrt", "pow", "log", "ln", "exp", "sin", "cos", "tan", "asin", "acos", "atan", "atan2", "sinh", "cosh", "tanh", "asinh", "acosh", "atanh", "degrees", "radians", "pi", "tau", "e", "vlength", "vnormalize", "vdot", "vcross", "vaxis_rotate", "vrotate", "vturbulence", "x", "y", "z", "t", "u", "v", "red", "green", "blue", "filter", "transmit", "gray", "grey",
		"clock", "clock_delta", "clock_on", "final_clock", "final_frame", "frame_number", "initial_clock", "initial_frame", "image_width", "image_height", "test_camera_1", "test_camera_2", "test_camera_3", "test_camera_4",
		"if", "ifdef", "ifndef", "else", "end", "switch", "case", "range", "break", "while", "for", "do", "macro", "function", "return", "debug", "error", "warning", "render", "statistics", "status",
		"aa_threshold", "aa_level", "all_intersections", "always_sample", "ambient_light", "aspect_ratio", "assumed_gamma", "max_intersections", "max_trace_level", "number_of_waves", "radiosity", "photons", "subsurface",
		"clipped_by", "bounded_by", "no_shadow", "no_image", "no_reflection", "double_illuminate", "hollow", "sturm", "hierarchy", "inverse", "open", "water_level", "split_union", "cutaway_textures", "smooth", "uv_mapping", "uv_vectors",
		"collect", "pass_through", "autostop", "expand_thresholds", "gather", "load_file", "save_file", "spacing", "target", "media_attenuation", "media_interaction",
	}
