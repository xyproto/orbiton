...
// GetWords takes a string with words and several color-strings, like "blue". Color the
// words with the corresponding colors and return the string.
func GetWords(line string, colors ...string) string {
	var ok bool
...
func ColorString(line, colors string) string {
	return GetWords(line, strings.Split(colors, " ")...)
}
