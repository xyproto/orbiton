...
func main() {
	...
	// Run the main editor loop (bubbletea or legacy)
	userMessage, stopParent, err := RunLoop(tty, fnord, lineNumber, colNumber, forceFlag, theme, syntaxHighlight, monitorAndReadOnlyFlag, nanoMode, createDirectoriesFlag, quickHelpFlag, noQuickHelpFlag, formatFlag)
