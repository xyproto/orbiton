...
func adjustSyntaxHighlightingKeywords(m mode.Mode) {
	...
	case mode.Make, mode.Shell:
		addKeywords := []string{"--force", "-f", "checkout", "clean", "configure", "dd", "do", "doas", "done", "endif", "exec", "fdisk", "for", "gdisk", "ifeq", "ifneq", "in", "make", "mv", "ninja", "rm", "rmdir", "setopt", "su", "sudo", "while"}
