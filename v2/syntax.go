...
func adjustSyntaxHighlightingKeywords(m mode.Mode) {
	...
	case mode.Config:
		removeKeywords([]string{"auto", "build", "default", "for", "from", "get", "install", "int", "local", "no", "not", "package", "type", "var", "with"})
...
func (e *Editor) SingleLineCommentMarker() string {
	...
	case mode.Algol68, mode.Bazel, mode.CMake, mode.Config, mode.Crystal, mode.Docker, mode.GDScript, mode.Just, mode.Make, mode.Nim, mode.Mojo, mode.PolicyLanguage, mode.Python, mode.Shell:
		return "#"
