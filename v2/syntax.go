...
var (
	...
	// Lilypond
	lilypondWords = []string{"AccidentalSuggestion", "AmbitusLine", "Balloon_engraver", "BarNumber", "ChordGrid", "ChordNames", "Completion_heads_engraver", "Completion_rest_engraver", "CueVoice", "DrumStaff", "DynamicLineSpanner", "Engraver_group", "Ez_numbers_engraver", "Forbid_line_break_engraver", "FretBoards", "GregorianTranscriptionStaff", "Grid_line_span_engraver", "Grid_point_engraver", "HorizontalBracketText", "Horizontal_bracket_engraver", "KievanStaff", "KievanVoice", "Mark_engraver", "Measure_grouping_engraver", "MensuralStaff", "MensuralVoice", "MultiMeasureRestScript", "MultiMeasureRestText", "NoteNames", "Note_heads_engraver", "Note_name_engraver", "NullVoice", "OneStaff", "Performer_group", "PianoStaff", "Pitch_squash_engraver", "R", "RhythmicStaff", "Score_engraver", "Score_performer", "Span_stem_engraver", "Staff.midiInstrument", "Staff_collecting_engraver", "Staff_symbol_engraver", "TabStaff", "TabVoice", "Text_mark_engraver", "TieColumn", "Timing", "TupletNumber", "VaticanaLyrics", "VaticanaScore", "VaticanaStaff", "VaticanaVoice", "VerticalAxisGroup", "Voice", "Volta_engraver", "X-offset", "\\EnableGregorianDivisiones", "\\IIJ", "\\IJ", "\\RemoveAllEmptyStaves", "\\RemoveEmptyStaves", "\\abs-fontsize", "\\absolute", "\\accent", "\\accentus", "\\accepts", "\\acciaccatura", "\\accidental", "\\accidentalStyle", "\\addChordShape", "\\addInstrumentDefinition", "\\addQuote", "\\addlyrics", "\\aeolian", "\\after", "\\afterGrace", "\\aikenHeads", "\\aikenHeadsMinor", "\\aikenThinHeads", "\\aikenThinHeadsMinor", "\\alias", "\\align-on-other", "\\allowPageTurn", "\\allowVoltaHook", "\\alterBroken", "\\alternative", "\\ambitusAfter", "\\appendToTag", "\\applyContext", "\\applyMusic", "\\applyOutput", "\\applySwing", "\\applySwingWithOffset", "\\appoggiatura", "\\arabicStringNumbers", "\\arpeggio", "\\arpeggioArrowDown", "\\arpeggioArrowUp", "\\arpeggioBracket", "\\arpeggioNormal", "\\arpeggioParenthesis", "\\arpeggioParenthesisDashed", "\\arrow-head", "\\articulate", "\\ascendens", "\\assertBeamQuant", "\\assertBeamSlope", "\\auctum", "\\augmentum", "\\auto-footnote", "\\autoBeamOff", "\\autoBeamOn", "\\autoBreaksOff", "\\autoBreaksOn", "\\autoChange", "\\autoLineBreaksOff", "\\autoLineBreaksOn", "\\autoPageBreaksOff", "\\autoPageBreaksOn", "\\backslashed-digit", "\\balloonGrobText", "\\balloonLengthOff", "\\balloonLengthOn", "\\balloonText", "\\bar", "\\barNumberCheck", "\\bassFigureExtendersOff", "\\bassFigureExtendersOn", "\\bassFigureStaffAlignmentDown", "\\bassFigureStaffAlignmentNeutral", "\\bassFigureStaffAlignmentUp", "\\beam", "\\beamExceptions", "\\bendAfter", "\\bendHold", "\\bendStartLevel", "\\blackTriangleMarkup", "\\bold", "\\book", "\\bookOutputName", "\\bookOutputSuffix", "\\bookpart", "\\box", "\\bp", "\\bracket", "\\break", "\\breakDynamicSpan", "\\breathe", "\\breve", "\\cadenzaOff", "\\cadenzaOn", "\\caesura", "\\caps", "\\cavum", "\\center-align", "\\center-column", "\\change", "\\char", "\\chordRepeats", "\\chordmode", "\\chords", "\\circle", "\\circulus", "\\clef", "\\cm", "\\coda", "\\codaMark", "\\column", "\\column-lines", "\\combine", "\\compound-meter", "\\compoundMeter", "\\compressEmptyMeasures", "\\compressMMRests", "\\concat", "\\consists", "\\context", "\\cr", "\\cresc", "\\crescHairpin", "\\crescTextCresc", "\\crossStaff", "\\cueClef", "\\cueClefUnset", "\\cueDuring", "\\cueDuringWithClef", "\\customTabClef", "\\dashBang", "\\dashDash", "\\dashDot", "\\dashHat", "\\dashLarger", "\\dashPlus", "\\dashUnderscore", "\\deadNote", "\\deadNotesOff", "\\deadNotesOn", "\\decr", "\\decresc", "\\default", "\\defaultTimeSignature", "\\defaultchild", "\\defineBarLine", "\\deminutum", "\\denies", "\\descendens", "\\dim", "\\dimHairpin", "\\dimTextDecr", "\\dimTextDecresc", "\\dimTextDim", "\\dir-column", "\\discant", "\\displayLilyMusic", "\\displayMusic", "\\displayScheme", "\\divisioMaior", "\\divisioMaxima", "\\divisioMinima", "\\dorian", "\\dotsDown", "\\dotsNeutral", "\\dotsUp", "\\doubleflat", "\\doublesharp", "\\downbow", "\\downmordent", "\\downprall", "\\draw-circle", "\\draw-dashed-line", "\\draw-dotted-line", "\\draw-hline", "\\draw-line", "\\draw-squiggle-line", "\\dropNote", "\\drummode", "\\drums", "\\dwn", "\\dynamic", "\\dynamicDown", "\\dynamicNeutral", "\\dynamicUp", "\\easyHeadsOff", "\\easyHeadsOn", "\\ellipse", "\\enablePolymeter", "\\endSpanners", "\\endcr", "\\enddecr", "\\episemFinis", "\\episemInitium", "\\epsfile", "\\espressivo", "\\etc", "\\eventChords", "\\expandEmptyMeasures", "\\eyeglasses", "\\f", "\\featherDurations", "\\fermata", "\\ff", "\\fff", "\\ffff", "\\fffff", "\\figured-bass", "\\figuremode", "\\figures", "\\fill-line", "\\fill-with-pattern", "\\filled-box", "\\finalis", "\\fine", "\\finger", "\\first-visible", "\\fixed", "\\flageolet", "\\flat", "\\flexa", "\\fontCaps", "\\fontsize", "\\footnote", "\\fp", "\\fraction", "\\freeBass", "\\frenchChords", "\\fret-diagram", "\\fret-diagram-terse", "\\fret-diagram-verbose", "\\fromproperty", "\\funkHeads", "\\funkHeadsMinor", "\\general-align", "\\germanChords", "\\glide", "\\glissando", "\\glissandoMap", "\\grace", "\\grobdescriptions", "\\halfopen", "\\halign", "\\harmonic", "\\harmonicByFret", "\\harmonicByRatio", "\\harmonicNote", "\\harmonicsOff", "\\harmonicsOn", "\\harp-pedal", "\\haydnturn", "\\hbracket", "\\hcenter-in", "\\header", "\\henzelongfermata", "\\henzeshortfermata", "\\hide", "\\hideKeySignature", "\\hideNotes", "\\hideSplitTiedTabNotes", "\\hideStaffSwitch", "\\hspace", "\\huge", "\\ictus", "\\if", "\\iij", "\\ij", "\\image", "\\improvisationOff", "\\improvisationOn", "\\in", "\\inStaffSegno", "\\incipit", "\\inclinatum", "\\include", "\\inherit-acceptability", "\\initialContextFrom", "\\instrumentSwitch", "\\inversion", "\\invertChords", "\\ionian", "\\italianChords", "\\italic", "\\jump", "\\justified-lines", "\\justify", "\\justify-field", "\\justify-line", "\\justify-string", "\\keepWithTag", "\\key", "\\kievanOff", "\\kievanOn", "\\killCues", "\\label", "\\laissezVibrer", "\\language", "\\languageRestore", "\\languageSaveAndChange", "\\large", "\\larger", "\\layout", "\\left-align", "\\left-brace", "\\left-column", "\\lheel", "\\ligature", "\\line", "\\linea", "\\lineprall", "\\locrian", "\\longa", "\\longfermata", "\\lookup", "\\lower", "\\ltoe", "\\lydian", "\\lyricmode", "\\lyrics", "\\lyricsto", "\\magnify", "\\magnifyMusic", "\\magnifyStaff", "\\major", "\\makeClusters", "\\makeDefaultStringTuning", "\\marcato", "\\mark", "\\markLengthOff", "\\markLengthOn", "\\markalphabet", "\\markletter", "\\markup", "\\markupMap", "\\markuplist", "\\maxima", "\\melisma", "\\melismaEnd", "\\mergeDifferentlyDottedOff", "\\mergeDifferentlyDottedOn", "\\mergeDifferentlyHeadedOff", "\\mergeDifferentlyHeadedOn", "\\mf", "\\midi", "\\minor", "\\mixolydian", "\\mm", "\\modalInversion", "\\modalTranspose", "\\mordent", "\\mp", "\\multi-measure-rest-by-number", "\\musicLength", "\\musicMap", "\\musicglyph", "\\n", "\\name", "\\natural", "\\new", "\\newSpacingSection", "\\noBeam", "\\noBreak", "\\noPageBreak", "\\noPageTurn", "\\normal-size-sub", "\\normal-size-super", "\\normal-text", "\\normal-weight", "\\normalsize", "\\note", "\\note-by-number", "\\notemode", "\\null", "\\number", "\\numericTimeSignature", "\\octaveCheck", "\\offset", "\\omit", "\\on-the-fly", "\\once", "\\oneVoice", "\\open", "\\oriscus", "\\ottava", "\\oval", "\\overlay", "\\override", "\\override-lines", "\\overrideProperty", "\\overrideTimeSignatureSettings", "\\overtie", "\\p", "\\pad-around", "\\pad-markup", "\\pad-to-box", "\\pad-x", "\\page-link", "\\page-ref", "\\pageBreak", "\\pageTurn", "\\palmMute", "\\palmMuteOn", "\\paper", "\\parallelMusic", "\\parenthesize", "\\partCombine", "\\partCombineApart", "\\partCombineAutomatic", "\\partCombineChords", "\\partCombineDown", "\\partCombineForce", "\\partCombineSoloI", "\\partCombineSoloII", "\\partCombineUnisono", "\\partCombineUp", "\\partial", "\\path", "\\pattern", "\\pes", "\\phrasingSlurDashPattern", "\\phrasingSlurDashed", "\\phrasingSlurDotted", "\\phrasingSlurDown", "\\phrasingSlurHalfDashed", "\\phrasingSlurHalfSolid", "\\phrasingSlurNeutral", "\\phrasingSlurSolid", "\\phrasingSlurUp", "\\phrygian", "\\pitchedTrill", "\\pointAndClickOff", "\\pointAndClickOn", "\\pointAndClickTypes", "\\polygon", "\\portato", "\\postscript", "\\pp", "\\ppp", "\\pppp", "\\ppppp", "\\prall", "\\pralldown", "\\prallmordent", "\\prallprall", "\\prallup", "\\preBend", "\\preBendHold", "\\predefinedFretboardsOff", "\\predefinedFretboardsOn", "\\property-recursive", "\\propertyOverride", "\\propertyRevert", "\\propertySet", "\\propertyTweak", "\\propertyUnset", "\\pt", "\\pushToTag", "\\put-adjacent", "\\qr-code", "\\quilisma", "\\quoteDuring", "\\raise", "\\raiseNote", "\\reduceChords", "\\relative", "\\remove", "\\removeWithTag", "\\repeat", "\\repeatTie", "\\replace", "\\resetRelativeOctave", "\\responsum", "\\rest", "\\rest-by-number", "\\retrograde", "\\reverseturn", "\\revert", "\\revertTimeSignatureSettings", "\\rfz", "\\rheel", "\\rhythm", "\\right-align", "\\right-brace", "\\right-column", "\\rightHandFinger", "\\romanStringNumbers", "\\rotate", "\\rounded-box", "\\rtoe", "\\sacredHarpHeads", "\\sacredHarpHeadsMinor", "\\sans", "\\scale", "\\scaleDurations", "\\score", "\\score-lines", "\\section", "\\sectionLabel", "\\segno", "\\segnoMark", "\\semiGermanChords", "\\semicirculus", "\\semiflat", "\\semisharp", "\\serif", "\\sesquiflat", "\\sesquisharp", "\\set", "\\settingsFrom", "\\sf", "\\sff", "\\sfz", "\\shape", "\\sharp", "\\shiftDurations", "\\shiftOff", "\\shiftOn", "\\shiftOnn", "\\shiftOnnn", "\\shortfermata", "\\showKeySignature", "\\showStaffSwitch", "\\signumcongruentiae", "\\simple", "\\single", "\\skip", "\\slashSeparator", "\\slashed-digit", "\\slashedGrace", "\\slashturn", "\\slurDashPattern", "\\slurDashed", "\\slurDotted", "\\slurDown", "\\slurHalfDashed", "\\slurHalfSolid", "\\slurNeutral", "\\slurSolid", "\\slurUp", "\\small", "\\smallCaps", "\\smaller", "\\snappizzicato", "\\sostenutoOff", "\\sostenutoOn", "\\sourcefileline", "\\sourcefilename", "\\southernHarmonyHeads", "\\southernHarmonyHeadsMinor", "\\sp", "\\spp", "\\staccatissimo", "\\staccato", "\\staff-space", "\\staffHighlight", "\\startGroup", "\\startStaff", "\\startTrillSpan", "\\stdBass", "\\stdBassIV", "\\stdBassV", "\\stdBassVI", "\\stemDown", "\\stemNeutral", "\\stemUp", "\\stencil", "\\stopGroup", "\\stopStaff", "\\stopStaffHighlight", "\\stopTrillSpan", "\\stopped", "\\storePredefinedDiagram", "\\string-lines", "\\stringTuning", "\\stropha", "\\strut", "\\styledNoteHeads", "\\sub", "\\super", "\\sustainOff", "\\sustainOn", "\\tabChordRepeats", "\\tabChordRepetition", "\\tabFullNotation", "\\table", "\\table-of-contents", "\\tag", "\\tagGroup", "\\taor", "\\teeny", "\\tempo", "\\temporary", "\\tenuto", "\\textEndMark", "\\textLengthOff", "\\textLengthOn", "\\textMark", "\\textSpannerDown", "\\textSpannerNeutral", "\\textSpannerUp", "\\thumb", "\\tie", "\\tieDashPattern", "\\tieDashed", "\\tieDotted", "\\tieDown", "\\tieHalfDashed", "\\tieHalfSolid", "\\tieNeutral", "\\tieSolid", "\\tieUp", "\\tied-lyric", "\\time", "\\times", "\\tiny", "\\tocItem", "\\tocItemWithDotsMarkup", "\\translate", "\\translate-scaled", "\\transparent", "\\transpose", "\\transposedCueDuring", "\\transposition", "\\treCorde", "\\triangle", "\\trill", "\\tripletFeel", "\\tuplet", "\\tupletDown", "\\tupletNeutral", "\\tupletSpan", "\\tupletUp", "\\turn", "\\tweak", "\\type", "\\typewriter", "\\unHideNotes", "\\unaCorda", "\\underline", "\\undertie", "\\undo", "\\unfoldRepeats", "\\unfolded", "\\unless", "\\unset", "\\upbow", "\\upmordent", "\\upprall", "\\upright", "\\varcoda", "\\vcenter", "\\verbatim-file", "\\version", "\\versus", "\\verylongfermata", "\\veryshortfermata", "\\virga", "\\virgula", "\\voiceFour", "\\voiceFourStyle", "\\voiceNeutralStyle", "\\voiceOne", "\\voiceOneStyle", "\\voiceThree", "\\voiceThreeStyle", "\\voiceTwo", "\\voiceTwoStyle", "\\voices", "\\void", "\\volta", "\\volta-number", "\\vshape", "\\vspace", "\\walkerHeads", "\\walkerHeadsMinor", "\\whiteTriangleMarkup", "\\whiteout", "\\with", "\\with-color", "\\with-dimension", "\\with-dimension-from", "\\with-dimensions", "\\with-dimensions-from", "\\with-link", "\\with-outline", "\\with-string-transformer", "\\with-true-dimension", "\\with-true-dimensions", "\\with-url", "\\withMusicProperty", "\\woodwind-diagram", "\\wordwrap", "\\wordwrap-field", "\\wordwrap-lines", "\\wordwrap-string", "\\xNote", "\\xNotesOff", "\\xNotesOn", "add-grace-property", "add-stem-support", "add-toc-item!", "additionalPitchPrefix", "afterGraceFraction", "alignAboveContext", "alignBelowContext", "ambitusAfter", "annotate-spacing", "arpeggio-direction", "articulation-event", "associatedVoice", "aug", "auto-first-page-number", "autoBeaming", "banjo-c-tuning", "banjo-double-c-tuning", "banjo-double-d-tuning", "banjo-modal-tuning", "banjo-open-d-tuning", "banjo-open-dm-tuning", "banjo-open-g-tuning", "barNumberVisibility", "bartype", "base-shortest-duration", "baseMoment", "beatStructure", "binding-offset", "blank-after-score-page-penalty", "blank-last-page-penalty", "blank-page-penalty", "bookTitleMarkup", "bookpart-level-page-numbering", "bottom-margin", "bracket", "break-align-symbols", "break-visibility", "breakable", "breakbefore", "check-consistency", "choral", "choral-cautionary", "chordChanges", "chordNameExceptions", "chordNameLowercaseMinor", "chordNameSeparator", "chordNoteNamer", "chordPrefixSpacer", "chordRootNamer", "clip-regions", "color", "common-shortest-duration", "context-spec-music", "controlpitch", "countPercentRepeats", "crescendo-event", "crescendoSpanner", "crescendoText", "cross", "currentBarNumber", "debug-beam-scoring", "debug-slur-scoring", "debug-tie-scoring", "decrescendoSpanner", "decrescendoText", "default", "default-staff-staff-spacing", "dim", "dodecaphonic", "dodecaphonic-first", "dodecaphonic-no-repeat", "drumPitchNames", "drumPitchTable", "drumStyleTable", "dynamic-event", "explicitClefVisibility", "explicitKeySignatureVisibility", "extra-offset", "extra-spacing-height", "extra-spacing-width", "figuredBassAlterationDirection", "figuredBassPlusDirection", "figuredBassPlusStrokedAlist", "fingeringOrientations", "first-page-number", "followVoice", "font-interface", "font-size", "fontSize", "fonts", "footnote-separator-markup", "forget", "four-string-banjo", "fret-diagram-interface", "glide", "gridInterval", "grob-interface", "grow-direction", "horizontal-shift", "indent", "inner-margin", "keepAliveInterfaces", "last-bottom-spacing", "layout-set-staff-size", "left-margin", "line-width", "ly:minimal-breaking", "ly:one-line-auto-height-breaking", "ly:one-line-breaking", "ly:one-page-breaking", "ly:optimal-breaking", "ly:page-turn-breaking", "m", "magnification->font-size", "magstep", "maj", "majorSevenSymbol", "make-dynamic-script", "make-relative", "markup-markup-spacing", "markup-system-spacing", "max-systems-per-page", "measureBarType", "measureLength", "measurePosition", "midiBalance", "midiChannelMapping", "midiChorusLevel", "midiDrumPitches", "midiExpression", "midiPanPosition", "midiReverbLevel", "min-systems-per-page", "minimum-Y-extent", "minimumFret", "minimumPageTurnLength", "minimumRepeatLengthForPageTurn", "minorChordModifier", "mixed", "mode", "modern", "modern-cautionary", "modern-voice", "modern-voice-cautionary", "musicQuotes", "neo-modern", "neo-modern-cautionary", "neo-modern-voice", "neo-modern-voice-cautionary", "no-reset", "noChordSymbol", "nonstaff-nonstaff-spacing", "nonstaff-relatedstaff-spacing", "nonstaff-unrelatedstaff-spacing", "note-event", "noteNameFunction", "noteNameSeparator", "ottavation", "ottavation-numbers", "ottavation-ordinals", "ottavation-simple-ordinals", "ottavationMarkups", "outer-margin", "output-count", "output-def", "output-suffix", "outside-staff-horizontal-padding", "outside-staff-padding", "outside-staff-priority", "page-breaking", "page-breaking-system-system-spacing", "page-count", "page-number-type", "page-spacing-weight", "paper-height", "paper-width", "partCombineListener", "pedalSustainStyle", "percent", "piano", "piano-cautionary", "pitchnames", "predefinedDiagramTable", "print-all-headers", "print-first-page-number", "print-page-number", "printAccidentalNames", "printNotesLanguage", "printOctaveNames", "quotedCueEventTypes", "quotedEventTypes", "r", "ragged-bottom", "ragged-last", "ragged-last-bottom", "ragged-right", "remove-empty", "remove-first", "remove-grace-property", "remove-layer", "repeatCommands", "repeatCountVisibility", "reset-footnotes-on-new-page", "rest-event", "restNumberThreshold", "restrainOpenStrings", "rgb-color", "right-margin", "s", "score-markup-spacing", "score-system-spacing", "scoreTitleMarkup", "self-alignment-X", "set-global-staff-size", "short-indent", "showFirstLength", "showLastLength", "skipBars", "skipTypesetting", "slashChordSeparator", "slur-event", "space-alist", "spacing", "staff-affinity", "staff-padding", "staff-staff-spacing", "staffgroup-staff-spacing", "start-repeat", "startAcciaccaturaMusic", "startAppoggiaturaMusic", "startGraceMusic", "stem-spacing-correction", "stemLeftBeamCount", "stemRightBeamCount", "stopAcciaccaturaMusic", "stopAppoggiaturaMusic", "stopGraceMusic", "strictBeatBeaming", "stringNumberOrientations", "stringTunings", "strokeFingerOrientations", "subdivideBeams", "suggestAccidentals", "sus", "system-count", "system-separator-markup", "system-system-spacing", "systems-per-page", "teaching", "text", "tieWaitForNote", "timeSignatureFraction", "tocFormatMarkup", "tocIndentMarkup", "tocItemMarkup", "tocTitleMarkup", "top-margin", "top-markup-spacing", "top-system-spacing", "toplevel-bookparts", "toplevel-scores", "tremolo", "tuplet-slur", "tupletSpannerDuration", "two-sided", "unfold", "universal-color", "voice", "volta"}
