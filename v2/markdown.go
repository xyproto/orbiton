...
func quotedWordReplace(line string, quote rune, regular, quoted vt.AttributeColor) string {
...
func style(line, marker string, textColor, styleColor vt.AttributeColor) string {
