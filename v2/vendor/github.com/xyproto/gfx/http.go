...
// Local fork: the upstream file imports net/http to provide convenience
// functions (Get, GetPNG, GetImage, GetTileset) that are not needed.
// Replacing them with error-returning stubs avoids pulling net/http,
// crypto/tls and their transitive dependencies into the binary.
