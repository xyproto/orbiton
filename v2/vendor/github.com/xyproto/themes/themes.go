...
// TermHas256Colors reports whether the terminal supports >=256 colors.
...
func NewOrbTheme() Theme {
	return Theme{
		...
		DebugRegistersBackground:    vt.BackgroundDefault,
		DebugOutputBackground:       vt.BackgroundGreen,
		DebugLineIndicator:          vt.LightCyan,
		DebugInstructionsForeground: vt.LightGreen,
		DebugInstructionsBackground: vt.BackgroundDefault,
		BoxUpperEdge:                vt.White,
		BoxTitleColor:               vt.LightYellow,
		JumpToLetterColor:           vt.LightRed,
...
func NewLitmusTheme() Theme {
	return Theme{
		...
		XColor:                      vt.Red,
		TableBackground:             vt.BackgroundWhite,
...
// TextConfig returns a TextConfig struct that can be used for setting
// the syntax highlighting colors in the public DefaultTextConfig variable
...
func RegisterMonokaiColors() {
	vt.DarkColorMap["mkcomment"] = vt.TrueColor(0x46, 0x54, 0x57)
	vt.DarkColorMap["mkstring"] = vt.TrueColor(0xe6, 0xdb, 0x74)
	vt.DarkColorMap["mkident"] = vt.TrueColor(0xfd, 0x97, 0x1f)
	vt.DarkColorMap["mknumber"] = vt.TrueColor(0xae, 0x81, 0xff)
	vt.DarkColorMap["mkpreproc"] = vt.TrueColor(0xa6, 0xe2, 0x2e)
	vt.DarkColorMap["mkkeyword"] = vt.TrueColor(0xf9, 0x26, 0x72)
	vt.DarkColorMap["mktype"] = vt.TrueColor(0x66, 0xd9, 0xef)
	vt.DarkColorMap["mkplain"] = vt.TrueColor(0xf8, 0xf8, 0xf2)
	vt.DarkColorMap["mkescape"] = vt.TrueColor(0x66, 0xd9, 0xef)
	vt.DarkColorMap["mkpunct"] = vt.TrueColor(0xf8, 0xf8, 0xf2)
	vt.DarkColorMap["mkfunc"] = vt.TrueColor(0xa6, 0xe2, 0x2e)
	vt.DarkColorMap["mkcurly"] = vt.TrueColor(0xf8, 0xf8, 0xf2)
	vt.RebuildTagReplacers()
}

// NewMonokaiTheme creates the Monokai theme, inspired by the Monokai color scheme
// for TextMate by Wimer Hazenberg. Requires true-color or 256-color support.
func NewMonokaiTheme() Theme {
	return Theme{
		Name:                  "Monokai",
		Light:                 false,
		Foreground:            vt.TrueColor(0xf8, 0xf8, 0xf2),
		Background:            vt.TrueBackground(0x1b, 0x1d, 0x1e),
		StatusForeground:      vt.TrueColor(0xf8, 0xf8, 0xf2),
		StatusBackground:      vt.TrueBackground(0x45, 0x53, 0x54),
		TopRightForeground:    vt.TrueColor(0xf8, 0xf8, 0xf2),
		TopRightBackground:    vt.TrueBackground(0x1b, 0x1d, 0x1e),
		StatusErrorForeground: vt.TrueColor(0xf8, 0xf8, 0xf2),
		StatusErrorBackground: vt.TrueBackground(0x96, 0x00, 0x50),
		SearchHighlight:       vt.TrueColor(0xe6, 0xdb, 0x74),
		MultiLineComment:      vt.TrueColor(0x46, 0x54, 0x57),
		MultiLineString:       vt.TrueColor(0xe6, 0xdb, 0x74),
		HighlightForeground:   vt.TrueColor(0xf8, 0xf8, 0xf2),
		HighlightBackground:   vt.BackgroundDefault,
		Git:                   vt.TrueColor(0xa6, 0xe2, 0x2e),
		String:                "mkstring",
		Keyword:               "mkkeyword",
		Comment:               "mkcomment",
		Type:                  "mktype",
		...
		TextTag:               "mkkeyword",
		TextAttrName:          "mktype",
		TextAttrValue:         "mkstring",
		Decimal:               "mknumber",
		AndOr:                 "mkpunct",
		AngleBracket:          "mkkeyword",
		Dollar:                "mkpreproc",
		Star:                  "mkplain",
		Static:                "mkkeyword",
		Self:                  "mkident",
		...
		Public:                "mkpreproc",
		Whitespace:            "",
		AssemblyEnd:           "mkescape",
		Mut:                   "mkpreproc",
		CurlyBracket:          "mkcurly",
		IncludeSystem:         "mkfunc",
		RainbowParenColors: []vt.AttributeColor{
			vt.TrueColor(0xf9, 0x26, 0x72), vt.TrueColor(0xa6, 0xe2, 0x2e), vt.TrueColor(0x66, 0xd9, 0xef),
			vt.TrueColor(0xe6, 0xdb, 0x74), vt.TrueColor(0xae, 0x81, 0xff), vt.TrueColor(0xfd, 0x97, 0x1f), vt.TrueColor(0xf8, 0xf8, 0xf2),
		},
		MarkdownTextColor:           vt.TrueColor(0xf8, 0xf8, 0xf2),
		HeaderBulletColor:           vt.TrueColor(0x46, 0x54, 0x57),
		HeaderTextColor:             vt.TrueColor(0xe6, 0xdb, 0x74),
		ListBulletColor:             vt.TrueColor(0xf9, 0x26, 0x72),
		ListTextColor:               vt.TrueColor(0xf8, 0xf8, 0xf2),
		ListCodeColor:               vt.TrueColor(0xa6, 0xe2, 0x2e),
		CodeColor:                   vt.TrueColor(0x66, 0xd9, 0xef),
		CodeBlockColor:              vt.TrueColor(0x66, 0xd9, 0xef),
		ImageColor:                  vt.TrueColor(0xe6, 0xdb, 0x74),
		LinkColor:                   vt.TrueColor(0xae, 0x81, 0xff),
		QuoteColor:                  vt.TrueColor(0xe6, 0xdb, 0x74),
		QuoteTextColor:              vt.TrueColor(0xf8, 0xf8, 0xf2),
		HTMLColor:                   vt.TrueColor(0x66, 0xd9, 0xef),
		CommentColor:                vt.TrueColor(0x46, 0x54, 0x57),
		BoldColor:                   vt.TrueColor(0xe6, 0xdb, 0x74),
		ItalicsColor:                vt.TrueColor(0xf8, 0xf8, 0xf2),
		StrikeColor:                 vt.TrueColor(0x46, 0x54, 0x57),
		TableColor:                  vt.TrueColor(0xae, 0x81, 0xff),
		CheckboxColor:               vt.TrueColor(0xa6, 0xe2, 0x2e),
		XColor:                      vt.TrueColor(0xe6, 0xdb, 0x74),
		TableBackground:             vt.TrueBackground(0x1b, 0x1d, 0x1e),
		UnmatchedParenColor:         vt.TrueColor(0xf8, 0xf8, 0xf2),
		MenuTitleColor:              vt.TrueColor(0xe6, 0xdb, 0x74),
		MenuArrowColor:              vt.TrueColor(0xf9, 0x26, 0x72),
		MenuTextColor:               vt.TrueColor(0xf8, 0xf8, 0xf2),
		MenuHighlightColor:          vt.TrueColor(0x66, 0xd9, 0xef),
		MenuSelectedColor:           vt.TrueColor(0xf8, 0xf8, 0xf2),
		ManSectionColor:             vt.TrueColor(0xf9, 0x26, 0x72),
		ManSynopsisColor:            vt.TrueColor(0xe6, 0xdb, 0x74),
		BoxTextColor:                vt.TrueColor(0x1b, 0x1d, 0x1e),
		BoxBackground:               vt.TrueBackground(0xf8, 0xf8, 0xf2),
		ProgressIndicatorBackground: vt.TrueBackground(0xfd, 0x97, 0x1f),
		BoxHighlight:                vt.TrueColor(0xe6, 0xdb, 0x74),
		DebugRunningBackground:      vt.TrueBackground(0xa6, 0xe2, 0x2e),
		DebugStoppedBackground:      vt.TrueBackground(0xf9, 0x26, 0x72),
		DebugRegistersBackground:    vt.TrueBackground(0x66, 0xd9, 0xef),
		DebugOutputBackground:       vt.TrueBackground(0xe6, 0xdb, 0x74),
		DebugLineIndicator:          vt.TrueColor(0xa6, 0xe2, 0x2e),
		DebugInstructionsForeground: vt.TrueColor(0xe6, 0xdb, 0x74),
		DebugInstructionsBackground: vt.TrueBackground(0xf9, 0x26, 0x72),
		BoxUpperEdge:                vt.TrueColor(0xf8, 0xf8, 0xf2),
		BoxTitleColor:               vt.Black,
		JumpToLetterColor:           vt.TrueColor(0xfd, 0x97, 0x1f),
		NanoHelpForeground:          vt.TrueColor(0x1b, 0x1d, 0x1e),
		NanoHelpBackground:          vt.TrueBackground(0xf8, 0xf8, 0xf2),
		MultiCursorBackground:       vt.TrueBackground(0x40, 0x3d, 0x3d),
	}
}

// NewMonokai16Theme creates a 16-color approximation of the Monokai theme,
// for terminals that do not support 256 colors.
func NewMonokai16Theme() Theme {
	return Theme{
		...
		TopRightBackground:          vt.BackgroundBlack,
		StatusErrorForeground:       vt.White,
		StatusErrorBackground:       vt.BackgroundMagenta,
		SearchHighlight:             vt.Yellow,
		MultiLineComment:            vt.Gray,
		MultiLineString:             vt.Yellow,
		HighlightForeground:         vt.White,
		HighlightBackground:         vt.BackgroundDefault,
		Git:                         vt.LightGreen,
		String:                      "yellow",
		...
		Plaintext:                   "white",
		Tag:                         "lightmagenta",
		TextTag:                     "lightmagenta",
		TextAttrName:                "lightcyan",
		TextAttrValue:               "yellow",
		Decimal:                     "lightmagenta",
		AndOr:                       "white",
		AngleBracket:                "lightmagenta",
		Dollar:                      "lightgreen",
		Star:                        "white",
		Static:                      "lightmagenta",
		Self:                        "darkyellow",
		...
		CurlyBracket:                "white",
		IncludeSystem:               "lightgreen",
		RainbowParenColors:          []vt.AttributeColor{vt.LightMagenta, vt.LightGreen, vt.LightCyan, vt.Yellow, vt.White, vt.LightYellow, vt.LightBlue},
		MarkdownTextColor:           vt.White,
		HeaderBulletColor:           vt.Gray,
		HeaderTextColor:             vt.Yellow,
		ListBulletColor:             vt.LightMagenta,
