...
var languageIndentation = map[TabsSpaces][]Mode{
	...
	{2, true}: {Agda, Amber, Arduino, Assembly, Clojure, Config, Erlang, HTML, Haskell, JSON, Koka, Lua, ObjectPascal, Perl, PolicyLanguage, ReStructured, Shell, StandardML, Teal, Vim, Vim, XML},
	{3, true}: {Ada, Prolog}, // Ada and Prolog are special
	{4, true}: {Bat, Basic, Battlestar, CMake, CS, Cpp, Crystal, Doc, Elm, Email, Garnet, GDScript, Git, Haxe, JSON, Jakt, Java, JavaScript, Kotlin, Markdown, Mojo, Nim, Oak, Python, R, SQL, Scala, Subversion, Terra, Text, TypeScript, V, Zig},
