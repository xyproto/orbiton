...
var languageIndentation = map[TabsSpaces][]Mode{
	...
	{2, true}: {Agda, Algol68, Amber, Arduino, Assembly, Clojure, Config, Dart, Erlang, Fortran90, HTML, Haskell, Inko, JSON, Koka, Lilypond, Lua, ObjectPascal, Perl, PolicyLanguage, ReStructured, Scala, Shell, StandardML, Teal, Vim, Vim, XML},
