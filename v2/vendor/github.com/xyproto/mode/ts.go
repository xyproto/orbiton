...
var languageIndentation = map[TabsSpaces][]Mode{
	...
	{1, true}: {ABC},
	{2, true}: {Agda, Algol68, Amber, Arduino, Assembly, C3, Clojure, Config, CSS, CSound, Dart, Diff, Erlang, Fortran90, FSTAB, HTML, Haskell, Ignore, Ini, Inko, JSON, Koka, Lilypond, Lua, Nmap, Nix, ObjC, ObjectPascal, Perl, PolicyLanguage, ReStructured, Ruby, Scala, Scheme, Shell, StandardML, Teal, Vim, Vim, XML},
	{3, true}: {Ada, Prolog}, // Ada and Prolog are special
	{4, true}: {ASCIIDoc, Basic, Bat, Battlestar, Beef, CMake, CS, Cpp, Crystal, Docker, Elm, Email, Faust, FSharp, GDScript, Garnet, Git, Haxe, JSON, Jakt, Java, JavaScript, Kotlin, Markdown, Mojo, Nim, Oak, Ollama, PHP, Python, R, SCDoc, SQL, Starlark, Subversion, Swift, Terra, Text, TypeScript, V, Zig},
