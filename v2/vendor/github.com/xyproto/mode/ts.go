...
var languageIndentation = map[TabsSpaces][]Mode{
	...
	{2, true}: {Agda, Algol68, Amber, Arduino, Assembly, C3, Clojure, Config, CSS, Dart, Erlang, Fortran90, HTML, Haskell, Ignore, Ini, Inko, JSON, Koka, Lilypond, Lua, Nmap, ObjC, ObjectPascal, Perl, PolicyLanguage, ReStructured, Ruby, Scala, Scheme, Shell, StandardML, Teal, Vim, Vim, XML},
