...
var languageIndentation = map[TabsSpaces][]Mode{
	...
	{4, true}: {ASCIIDoc, Basic, Bat, Battlestar, Beef, CMake, Chuck, CS, Cpp, Crystal, Docker, Elm, Email, Faust, Flap, FSharp, GDScript, Garnet, Git, Haxe, JSON, Jakt, Java, JavaScript, Kotlin, Markdown, Mojo, Nim, Oak, Ollama, PHP, Python, R, Rust, SCDoc, SQL, Starlark, Subversion, Swift, Terra, Text, TypeScript, V, Zig},
	...
	{4, false}: {AIDL, C, Go, GoAssembly, HIDL, Just, Lisp, M4, Make, ManPage, Nroff, Odin, Shader, SuperCollider}, // Tabs
}
